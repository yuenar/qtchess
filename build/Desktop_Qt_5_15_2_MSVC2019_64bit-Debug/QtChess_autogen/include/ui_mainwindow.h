...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/images/chess.png"), QSize(), QIcon::Normal, QIcon::Off);
        MainWindow->setWindowIcon(icon);
        actionAbout = new QAction(MainWindow);
        actionAbout->setObjectName(QString::fromUtf8("actionAbout"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/images/helpabout.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/images/newgame.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionNewGame->setIcon(icon4);
        actionTie = new QAction(MainWindow);
        actionTie->setObjectName(QString::fromUtf8("actionTie"));
        actionTie->setEnabled(false);
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/images/tie.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionTie->setIcon(icon5);
        actionUndo = new QAction(MainWindow);
        actionUndo->setObjectName(QString::fromUtf8("actionUndo"));
        actionUndo->setEnabled(false);
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/images/fallback.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionUndo->setIcon(icon6);
        actionLose = new QAction(MainWindow);
        actionLose->setObjectName(QString::fromUtf8("actionLose"));
        actionLose->setEnabled(false);
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/images/fail.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionLose->setIcon(icon7);
        actionExit = new QAction(MainWindow);
        actionExit->setObjectName(QString::fromUtf8("actionExit"));
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/images/fileexit.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/images/flip.png"), QSize(), QIcon::Normal, QIcon::Off);
